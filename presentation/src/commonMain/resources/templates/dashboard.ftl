    ...
    <div class="card">
            ...
            <table class="kw-table js-table">
                ...
                <#list view.keywords as k>
                    <tr>
                        ...
                        <td class="col-pop" data-sort="${k.popularityValue}">
                            <#if k.hasPopularity>
        ...
        <#else>
            <div class="empty">
                ...
                <p class="muted">Ajoute-en un ci-dessus. Les données de popularité arriveront quand le fetch
                    tournera.</p>
            </div>
        </#if>
    </div>
