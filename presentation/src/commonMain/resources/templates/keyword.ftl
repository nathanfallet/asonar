...
<div class="detail-grid">
    <div class="card">
        ...
        <table class="kw-table">
            <thead><tr><th class="col-rank">#</th><th>App</th><th>Store ID</th></tr></thead>
            <tbody>
            <#list view.topApps as t>
            <tr><td class="col-rank"><span class="pos">${t.position}</span></td><td class="term">${t.appName}</td><td class="country">${t.storeAppId}</td></tr>
            </#list>
            </tbody>
        </table>
        <#else>
    ...
    <div class="card">
        ...
        <table class="kw-table">
            <thead><tr><th>App</th><th>Rang</th><th>Résultats</th><th class="col-when">Mesuré</th></tr></thead>
            <tbody>
            <#list view.ranks as r>
            <tr><td class="term">${r.appName}</td><td><strong>${r.rankLabel}</strong></td><td class="muted">${r.totalResults}</td><td class="col-when muted">${r.capturedAt}</td></tr>
            </#list>
            </tbody>
        </table>
        <#else>
        <div class="empty"><p class="muted">Aucune de nos apps n'a encore de rang relevé sur ce mot-clé.</p></div>
        </#if>
    </div>
</div>
</@l.page>
